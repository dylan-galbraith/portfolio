  ...
  return (
    <div id="work" className="work">
      ...
      <div className="work__item">
        ...
        <div>
          {hangman ? <p onClick={hangmanDropDown} className="work__item__more work__item__more--right">Learn Less	&#8593;</p> : <p onClick={hangmanDropDown} className="work__item__more work__item__more--right">Learn More &#8595;</p>}
        </div>
      </div>
      <div className={hangman ? "work__bio active" : "work__bio"} >
