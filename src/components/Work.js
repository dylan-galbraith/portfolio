  ...
  return (
    <div id="work" className="work">
      <div className="work__item">
        ...
        <p className="work__item__tech">REACT | SASS | JAVASCRIPT | FIREBASE | MYSQL | PRISMA | EXPRESS | NODE.JS</p>
        <p onClick={fitTrackDropDown} className="work__item__more">Learn More &#8594;</p>
        <div className={fitTrack ? "work__bio" : "hidden"} >
          <p className="work__item__info">I developed this project while in school as my final assignment. Given 10 days, we had to come up with an idea for a web application that would solve some type of issue. I built FitTrack, a mobile application that allows you to create your own exercises and routines, and track your progress at the gym.</p>
          <p className="work__item__info">To build this application, I used React and SASS for my front-end. For the back-end, I used MySQL and Prisma to build the database, along with Express and Node.js for the server.</p>
          <div className="work__item__links">
            <a href="https://fit-track.netlify.app/" className="work__item__link">https://fit-track.netlify.app/</a>
            <a href="https://github.com/dylan-galbraith/fit-track" className="work__item__link">https://github.com/dylan-galbraith/fit-track</a>
          </div>
        </div>
      </div>
