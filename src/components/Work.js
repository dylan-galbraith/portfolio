    ...
    <div id="work" className="work">
      ...
      <div className={fitTrack ? "work__bio active" : "work__bio"} >
        ...
        <div className="work__item__links">
          <a href="https://fit-track.netlify.app/" target="_blank" className="work__item__link work__item__link--right">https://fit-track.netlify.app/</a>
          <a href="https://github.com/dylan-galbraith/fit-track" target="_blank" className="work__item__link work__item__link--right">https://github.com/dylan-galbraith/fit-track</a>
        </div>
      </div>
      ...
      <div className={connectMD ? "work__bio work__bio--right active" : "work__bio work__bio--right"} >
        ...
        <div className="work__item__links">
          <a href="https://github.com/dylan-galbraith/tinder-md" target="_blank" className="work__item__link">https://github.com/dylan-galbraith/tinder-md</a>
        </div>
      </div>
      ...
      <div className={fitTrack ? "work__bio active" : "work__bio"} >
        ...
        <div className="work__item__links">
          <a href="https://github.com/dylan-galbraith/dylan-janet-hangman" target="_blank" className="work__item__link work__item__link--right">https://github.com/dylan-galbraith/dylan-janet-hangman</a>
        </div>
      </div>
