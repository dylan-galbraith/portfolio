  ...
  return (
    <div id="work" className="work">
      <div className="work__item">
        ...
        <p onClick={fitTrackDropDown} className="work__item__more work__item__more--right">Learn More &#8594;</p>
      ...
      <div className="work__item work__item--right">
        ...
        <p onClick={connectMDDropDown} className="work__item__more">Learn More &#8594;</p>
        <div className={connectMD ? "work__bio" : "hidden"} >
